...
int userTasks = 0, clock, userSleep = 0, exitCode, userSem = 0;
int preempcion = 0;
...
task_t *scheduler()
{
    ...
    // printf("Aqui estamos nós no scheduler com %d itens da pronta e %d filaDorme\n", userTasks, userSleep);
    if(userTasks > 0)
    {
...
//        printf("WWWWWWWWWWWWWWWAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA\n");
      }
   }
